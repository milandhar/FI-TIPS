...
//My Function
//tree traversal: pre-order vs post-order vs in-order
// function bstOrderedTraverse(currentRoot){
//   console.log(currentRoot)
//   if(currentRoot.left){
//     return bstOrderedTraverse(currentRoot.left)
//   } else{
//     console.log(currentRoot.data)
//     return bstOrderedTraverse(currentRoot.right)
//   }
// }
...
function bstOrderedTraverse(currentRoot){
  ...
  bstOrderedTraverse(currentRoot.left)
  console.log(currentRoot.data)
  bstOrderedTraverse(currentRoot.right)
}

bstOrderedTraverse(bst.root)
